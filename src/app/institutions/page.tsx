...
export const metadata: Metadata = {
  title: "Venue — BITE Campus",
  description:
    "ARC-T 2.0 is hosted at BITE Campus, Babatpur, Varanasi. Learn about the venue.",
};
      ...
      <section className="bg-gradient-to-b from-ivory to-cream px-4 pt-28 pb-16">
        <div className="mx-auto max-w-[800px] text-center">
          ...
          <p className="text-sm text-body">
            ARC-T 2.0 Recognition &amp; Guidance Day is hosted at BITE Campus,
            Babatpur, Varanasi.
          </p>
        </div>
      </section>
          ...
          <div className="rounded-xl border border-gold/20 bg-ivory p-6 md:flex md:items-start md:gap-8 md:p-8">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1 text-sm text-body">
                <p>
                  <strong>Director:</strong> Prof. O.P. Rai
                </p>
                <p>
                ...
                <p>
                  <strong>Affiliation:</strong> MGKVP (Mahatma Gandhi Kashi
                  Vidyapith)
                </p>
                <p>
